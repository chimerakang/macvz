...
| CRI-R11 (#103) | Probe vmexec `/dev/ptmx` handling for late prepared rootfs start | 🟡 Planned (treat or explain ENOENT during `remove(ptmx)`, then rerun the late-rootfs harness before any production CRI wiring) |
